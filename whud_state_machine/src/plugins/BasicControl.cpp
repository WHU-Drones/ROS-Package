 ...
 public:
  ...
  bool SetTask(ros::V_string param) {
    PluginBase::SetTask(param);
      ...
      {
        // set z axis speed
        takeoff.data.at(0)=(atof(param[1].c_str()));
        // set height
        takeoff.data.at(1)=(atof(param[2].c_str()));
      ...
      {
        // set z axis speed
        height_control.data.at(0)=(atof(param[1].c_str()));
        // set target height(relatively)
        height_control.data.at(1)=(atof(param[2].c_str()));
      ...
      else if(param[0]=="yaw_control")
      {
        ...
        yaw_control.data.at(0)=(atof(param[1].c_str()));
        yaw_control.data.at(1)=(atof(param[2].c_str()));
